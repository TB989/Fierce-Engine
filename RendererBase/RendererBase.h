...
struct MeshSettings {
	...
	typedef void (*PFN_SET_ORTHOGRAPHIC_PROJECTION_PROC)(float width,float height,float n,float f);
	typedef void (*PFN_SET_PERSPECTIVE_PROJECTION_PROC)(float aspect,float fov,float n,float f);
	...
	extern PFN_SET_ORTHOGRAPHIC_PROJECTION_PROC setOrthographicProjection;
	extern PFN_SET_PERSPECTIVE_PROJECTION_PROC setPerspectiveProjection;
